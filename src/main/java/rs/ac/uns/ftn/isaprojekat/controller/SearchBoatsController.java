...
//    String listBoatResults(Model model, @ModelAttribute(value="dateFrom") String dateFrom, BindingResult bindingResult, @ModelAttribute(value = "dateEnd") String dateEnd ){
//
